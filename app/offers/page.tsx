          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            {plans.map((plan, index) => (
              <motion.div
                ...
                className={`relative flex flex-col p-10 rounded-[3rem] border transition-all duration-500 overflow-hidden group ${plan.highlight
              ...
              >
                ...
                <Link
                  href="/contact"
                  className={`block w-full text-center py-5 rounded-2xl text-lg font-black transition-all ${plan.highlight
