...
export function Contact() {
  ...
  return (
    <section ref={ref} id="contact" className="bg-[#0F172A] py-24 lg:py-32">
          ...
          >
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className="w-12 h-12 rounded-lg bg-[#0F172A] flex items-center justify-center text-[#55D9DE] group-hover:bg-[#55D9DE] group-hover:text-[#0F172A] transition-all duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-12 bg-[#0F172A] rounded-lg px-4 text-[#F8FAFC] border border-[#334155] focus:border-[#55D9DE] transition-all focus:outline-none"
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full h-12 bg-[#0F172A] rounded-lg px-4 text-[#F8FAFC] border border-[#334155] focus:border-[#55D9DE] transition-all appearance-none cursor-pointer focus:outline-none"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#0F172A] rounded-lg px-4 py-3 text-[#F8FAFC] border border-[#334155] focus:border-[#55D9DE] transition-all resize-none focus:outline-none"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.99 }}
                className="w-full btn-accent py-4 rounded-lg font-bold flex items-center justify-center gap-3 text-[#0F172A]"
              >
                إرسال الرسالة
